...
export const workRecords = sqliteTable("work_records", {
  ...
  engagementScope: text("engagement_scope").notNull().default("none"),
  projectIdsJson: text("project_ids_json").notNull().default("[]"), organizationIdsJson: text("organization_ids_json").notNull().default("[]"), contactIdsJson: text("contact_ids_json").notNull().default("[]"), categoryIdsJson: text("category_ids_json").notNull().default("[]"),
  ...
  evidenceSummary: text("evidence_summary").notNull().default(""), evidenceReferenceIdsJson: text("evidence_reference_ids_json").notNull().default("[]"),
  ...
  schemaVersion: integer("schema_version").notNull().default(2), recordVersion: integer("record_version").notNull().default(1),
